    ...
    <>
      ...
      {!open && (
        <a
          ...
          className="fixed right-[26px] bottom-24 z-40 w-10 h-10 rounded-full bg-[#25D366] shadow-md flex items-center justify-center text-white hover:scale-110 hover:shadow-lg transition-all group focus:outline-none focus-visible:ring-4 focus-visible:ring-[#25D366]/40"
        >
